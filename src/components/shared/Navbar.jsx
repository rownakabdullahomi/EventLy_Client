...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      <li>
        <NavLink to="/about" className=" btn hover:btn-primary hover:btn-soft">
          About Us
        </NavLink>
      </li>
    </>
      ...
      <div className="  navbar-start">
        <div className="dropdown">
          ...
          >
            <Link
          to="/"
          className="my-3 text-2xl font-bold tracking-wide text-yellow-500 hover:text-gray-500 transition duration-300"
        >
          EventLy
        </Link>
            {links}
        ...
        <Link
          to="/"
          className="hidden lg:block text-2xl font-bold tracking-wide text-yellow-500 hover:text-gray-500 transition duration-300"
        >
          EventLy
        </Link>
      </div>
